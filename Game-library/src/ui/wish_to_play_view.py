...
class WishToPlayView(Frame):
    def __init__(self, root, open_main_menu):
        ...
        Label(self, text="Wish to Play", font=("Arial", 18)).pack(pady=10)
    ...
    def draw_game_list(self):
        ...
        games = game_service.get_game_by_status("wishlist")
        ...
        for game in games:
            ...
            Button(
                ...
                command=lambda game_id=game.game_id: self.change_status(game_id, "playing")
            ).pack(side="left", padx=10)
